...
FillTOPPluginInfo(TOP_PluginInfo *info)
{
	...
	// or numbers (a-z, 0-9)
	info->customOPInfo.opType->setString("Ndiin");

	// The opLabel is the text that will show up in the OP Create Dialog
	info->customOPInfo.opLabel->setString("The NDI In TOP receives image and audio data over IP from other Newtek NDI® (Network Data Interface) enabled applications.");
