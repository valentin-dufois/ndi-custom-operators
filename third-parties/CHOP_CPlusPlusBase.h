...
public:
	...
	virtual void
	getGeneralInfo(CHOP_GeneralInfo *, const OP_Inputs *, void *)
{
	}
	...
	virtual bool		
	getOutputInfo(CHOP_OutputInfo *, const OP_Inputs *, void *)
	{
		return false;
	}
	...
	// it won't be called.
	virtual void getChannelName(int32_t, OP_String * name, const OP_Inputs *, void *)
	{
	...
	virtual void	execute(CHOP_Output *, const OP_Inputs *, void* reserved1) = 0;
	...
	virtual void	
	getInfoDATEntries(int32_t, int32_t, OP_InfoDATEntries *, void *)
	{
	}
	...
	virtual void
	getWarningString(OP_String *, void *)
	{
	}
	...
	virtual void
	getInfoPopupString(OP_String *, void *)
	{
	}
	...
	virtual void        
	setupParameters(OP_ParameterManager *, void *)
	{
	}
