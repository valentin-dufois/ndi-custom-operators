...
FillTOPPluginInfo(TOP_PluginInfo *info)
{
	...
	// or numbers (a-z, 0-9)
	info->customOPInfo.opType->setString("Ndiout");

	// The opLabel is the text that will show up in the OP Create Dialog
	info->customOPInfo.opLabel->setString("The NDI Out TOP will send image and audio data over IP to other Newtek NDI® (Network Data Interface) enabled applications.");

	// Will be turned into a 3 letter icon on the nodes
	info->customOPInfo.opIcon->setString("NDO");
